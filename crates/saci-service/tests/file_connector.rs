...
//! build of SACI before it could read one byte format and write another through
...
node id=1 name="saci-file-connector" data_dir="{data_dir}"
...
node id=1 name="saci-file-append" data_dir="{data_dir}"
